...
abstract class SignUpRepository {
  ...
  Future<ApiResponse> verificationAuthNumber({required EmailAuthNumberRequest emailAuthNumberRequest});
}
...
class SignUpRepositoryImpl implements SignUpRepository{
  ...
  @override
  Future<ApiResponse> verificationAuthNumber({required EmailAuthNumberRequest emailAuthNumberRequest}) async {
    ApiResponse apiResponse =
    await _apiService.verificationAuthNumber(emailAuthNumberRequest.email, emailAuthNumberRequest.authCode).then((httpResponse) async {
      return ApiResponse(
          statusCode: httpResponse.response.statusCode!,
          data: httpResponse.data ?? "");
    }).onError((DioException e, stackTrace) async {
