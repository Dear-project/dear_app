          ...
          children: [
            Container(
                ...
                child: CupertinoTextField(
                  ...
                  decoration: BoxDecoration(),
                  onSubmitted: (_) {
                    _schoolVM.searchSchool(keyword: _schoolVM.searchKeywordController.value.text);
                  }
                )
            ),
            ...
            Container(
                child: CupertinoButton(
                    ...
                    child: Icon(
                      CupertinoIcons.search, color: Color(0xff787878),),
                    onPressed: () {
                      _schoolVM.searchSchool(
                          keyword: _schoolVM.searchKeywordController.value
                              .text);
                    })
            )
          ],
