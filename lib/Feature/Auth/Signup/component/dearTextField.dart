...
//
//   const DearTextField(this.type, {super.key});
//
//   @override
//   State<DearTextField> createState() => _DearTextFieldState(type);
// }
//
...
//   @override
//   void dispose() {
//     _topTextEditController.dispose();
//     _bottomTextEditController.dispose();
//     super.dispose();
//   }
//
//   _DearTextFieldState(this.type);
//
...
//         children: [
//           TextField(
//             controller: (getPosition(type) == TextFieldPosition.top.toString()) ? _topTextEditController : _bottomTextEditController,
//             onChanged: (value) {
//               print("${value}");
//             },
